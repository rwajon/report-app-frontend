async function getAllOrganizations() {
  ...
  //   document.querySelector(".message").classList += result.error
  //     ? " message-error"
  //     : " message-success";
                ...
                <tr>    
                    ...
                    <td>
                            <button type="button" id="${
                              key.id
                            }" onclick="deleteOrganization(this.attributes.id.value)">
                                    <i class="fas fa-trash"></i>
                            </button>
					</td>   
					<td>
						<a href="./editOrganisation.html?name=${key.name}&&id=${key.id}">
